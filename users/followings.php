...
$followings = $conn->query("SELECT shows.id AS id,shows.title AS title, shows.image AS image, shows.type AS type, shows.genre AS genre, shows.num_avalible AS num_avalible, shows.num_total AS num_total, followings.user_id, followings.show_id
FROM shows
