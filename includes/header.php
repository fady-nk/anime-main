<?php
  ...
  define("VIDEOSURL", "http://localhost/anime-main/admin-panel/episodes-admins/uploads");
            ...
            <div class="row">
                ...
                <div class="col-lg-2">
                    ...
                    <form action="<?php echo APPURL; ?>/search.php" method="post" class="form-inline my-2 my-lg-0">
                        <input name="keyword" style="border-radius:15px;margin-left:-150px;" class="form-control mr-sm-2" type="search" placeholder="Search" aria-label="Search">
                        <button name="submit" type="submit" style="background-color:red;outline:none;color:white;border-color:black;border-radius:15px;" class="btn btn-outline-success my-2 my-sm-0" type="submit">Search</button>
                    </form>
